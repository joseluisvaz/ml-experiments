...
if not args['template_task_id']:
    args['template_task_id'] = Task.get_task(
        project_name='ResNet', task_name='Experiment AdamW 512 transfecr').id
...
an_optimizer = HyperParameterOptimizer(
    ...
    hyper_parameters=[
        DiscreteParameterRange('lr', values=[0.000001, 0.0001, 0.00001, 0.001, 0.01, 0.1]),
    ],
    # this is the objective metric we want to maximize/minimize
    objective_metric_title='loss/val',
    objective_metric_series='loss/val',
